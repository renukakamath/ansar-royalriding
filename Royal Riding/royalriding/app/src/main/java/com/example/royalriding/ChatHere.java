...
//		url = sh.getString("url", "");
		...
		b1.setOnClickListener(new View.OnClickListener() 
		{
			public void onClick(View arg0)
			{
				...
				else
				{
			        ...
			        String q = "/chat?sender_id="+sh.getString("log_id", "")+"&receiver_id="+viewrequest.tid+"&details="+chat;
			        q=q.replace(" ","%20");
			        JR.execute(q);
	...
	void getChats() {
			...
			JsonReq JR=new JsonReq();
	        JR.json_response=(JsonResponse) ChatHere.this;
	        String q = "/chatdetail?sender_id="+sh.getString("log_id", "")+"&receiver_id="+viewrequest.tid;
	        q=q.replace(" ","%20");
