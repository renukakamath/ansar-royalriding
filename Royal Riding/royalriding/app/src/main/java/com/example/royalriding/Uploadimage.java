...
//        Toast.makeText(getApplicationContext(), viewrequest.tid, Toast.LENGTH_LONG).show();
...
//                Toast.makeText(getApplicationContext(), "login id : " +    sh.getString("log_id",""), Toast.LENGTH_SHORT).show();
    ...
    private void sendAttach() {
        ...
        try {
            ...
            String q = "http://" + Ipsettings.ip + "/api/uploadimage" ;
            ...
            aa.put("tid", viewrequest.tid.getBytes());
