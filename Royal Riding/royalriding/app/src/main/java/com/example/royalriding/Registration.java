...
public class Registration extends AppCompatActivity implements JsonResponse {
    ...
    Button b1;
    String fname,lname,place,phone,email,username,password,licence,aadaar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        e8=(EditText)findViewById(R.id.licence) ;
        e9=(EditText)findViewById(R.id.aadaar) ;
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                licence=e8.getText().toString();
                aadaar=e9.getText().toString();
                ...
                else if(password.equalsIgnoreCase(""))
                {
                    ...
                    String q = "/Registration?fname=" + fname + "&lname=" + lname + "&place=" + place + "&phone=" + phone + "&email=" + email + "&username=" + username + "&password=" + password + "&licence=" + licence +"&aadaar="+aadaar;
                    q = q.replace(" ", "%20");
                    JR.execute(q);
                }
            }
